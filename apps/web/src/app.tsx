...
export const layout: RunTimeLayoutConfig = ({
  ...
  return {
    ...
    avatarProps: {
      ...
      children: (initialState?.currentUser?.name || 'U').slice(0, 1),
...
export const request: RequestConfig = {
  // 开发走 proxy；生产通过 UMI_APP_API_URL 指向 Nest（如 http://IP:10001）
  baseURL: isDev ? '' : process.env.UMI_APP_API_URL || '',
  ...errorConfig,
};
