...
var Hashtable = (function () {
  ...
  function m(r, i) {
    ...
    (this.put = function (e, t) {
      ...
      return (
        (r = v(l, n)),
        r
          ? ((i = r.getEntryForKey(e)),
            i ? ((s = i[1]), (i[1] = t)) : r.addEntry(e, t))
          : ((r = new a(n, e, t, h)), (f[f.length] = r), (l[n] = r)),
        s
      );
    }),
      (this.get = function (e) {
    ...
    (this.keys = p("keys")),
      ...
      (this.remove = function (e) {
        ...
        return (
          s &&
            ((i = s.removeEntryForKey(e)),
            i !== null &&
              (s.entries.length || ((r = d(f, n)), t(f, r), delete l[n]))),
          i
        );
      }),
      (this.size = function () {
  ...
  var e = "function",
    t =
      typeof Array.prototype.splice == e
        ? function (e, t) {
            e.splice(t, 1);
          }
        : function (e, t) {
...
(function (e) {
  ...
  function l(e, n) {
    ...
    n == 0 &&
      (e.indexOf("_") != -1
        ? (e = e.split("_")[1].toLowerCase())
        : e.indexOf("-") != -1 && (e = e.split("-")[1].toLowerCase()));
    var u = t.get(e);
    if (u) {
      var l = o[u];
      l && ((r = l[0]), (i = l[1]));
  ...
  (e.fn.formatNumber = function (t, n, r) {
    return this.each(function () {
      ...
      var i;
      e(this).is(":input")
        ? (i = new String(e(this).val()))
        : (i = new String(e(this).text()));
    ...
    (e._formatNumber = function (t, n, r, i, s) {
      ...
      n.format.indexOf(".") == -1
        ? (E = n.format)
        : (E = n.format.substring(0, n.format.indexOf(".")));
      var S = "";
      ...
      return (
        !S && E.indexOf("0", E.length - 1) !== -1 && (S = "0"),
        (h = S + h),
        t < 0 && s && i.length > 0 ? (i = f + i) : t < 0 && (h = f + h),
        n.decimalSeparatorAlwaysShown ||
          (h.lastIndexOf(u) == h.length - 1 &&
    ...
    (e.fn.parseNumber = function (t, n, r) {
      ...
      if (s) {
        n &&
          (e(this).is(":input")
            ? e(this).val(s.toString())
            : e(this).text(s.toString()));
        if (r) return s;
      }
    }),
  ...
  (function () {
    ...
    this.tmpl = function t(n, r) {
      var i = /\W/.test(n)
        ...
        : (e[n] = e[n] || t(document.getElementById(n).innerHTML));
      return r ? i(r) : i;
    };
  })(),
  (function (e) {
    (e.baseClass = function (t) {
      ...
      (e.fn.toggleDependClass = function (t, n) {
        ...
        return this.each(function () {
          var n = e.baseClass(this);
          n &&
            (e(this).is("." + n + r.delimiter + t)
              ? e(this).removeClass(n + r.delimiter + t)
              : e(this).addClass(n + r.delimiter + t));
        });
      });
  })(jQuery),
  (function (e) {
    ...
    (t.prototype.oninit = function () {}),
      ...
      (t.prototype._bindEvent = function (e, t, n) {
        ...
        this.supportTouches_
          ? e.get(0).addEventListener(this.events_[t], n, !1)
          : e.bind(this.events_[t], n);
      }),
      (t.prototype._events = function () {
        var t = this;
        (this.supportTouches_ =
          e.browser.webkit && navigator.userAgent.indexOf("Mobile") != -1),
          (this.events_ = {
          ...
          this._bindEvent(e(document), "move", function (e) {
            t.is.drag &&
              (e.stopPropagation(), e.preventDefault(), t._mousemove(e));
          }),
      ...
      (t.prototype._mouseup = function (t) {
        ...
        this.is.drag &&
          ...
          this.outer &&
            ...
            e.browser.msie && e.browser.version == "6.0"
              ? this.outer.css({
                  height: "100%",
                })
              : this.outer.css({
  ...
  (function (e) {
      ...
      return typeof e == "undefined"
        ...
        : e instanceof Array ||
          ...
          (typeof e.length == "number" &&
            typeof e.splice != "undefined" &&
            typeof e.propertyIsEnumerable != "undefined" &&
    ...
    (e.slider = function (t, n) {
      var i = e(t);
      return (
        i.data("jslider") || i.data("jslider", new r(t, n)), i.data("jslider")
      );
    }),
              ...
              switch (n) {
                ...
                case "prc":
                  if (o(s[1]) && o(s[2])) {
                    ...
                    u(f[0]) &&
                      u(s[1]) &&
                      (f[0]._set(s[1]), f[0].setIndexOver()),
                      u(f[1]) &&
                        u(s[2]) &&
                        (f[1]._set(s[2]), f[1].setIndexOver());
                  } else if (o(s[1])) {
                    var f = a.getPointers();
                    u(f[0]) &&
                      u(s[1]) &&
    ...
    var n = {
      ...
      selector: ".jslider-",
      template: tmpl(
        '<span class="<%=className%>"><table><tr><td><div class="<%=className%>-bg"><i class="l"></i><i class="f"></i><i class="r"></i><i class="v"></i></div><div class="<%=className%>-pointer"></div><div class="<%=className%>-pointer <%=className%>-pointer-to"></div><div class="<%=className%>-label"><span><%=settings.from%></span></div><div class="<%=className%>-label <%=className%>-label-to"><span><%=settings.to%></span><%=settings.dimension%></div><div class="<%=className%>-value"><span></span><%=settings.dimension%></div><div class="<%=className%>-value <%=className%>-value-to"><span></span><%=settings.dimension%></div><div class="<%=className%>-scale"><%=scale%></div></td></tr></table></span>'
      ),
    };
    (r.prototype.init = function (t, r) {
      (this.settings = e.extend(!0, {}, n.settings, r ? r : {})),
        ...
        this.settings.calculate &&
          e.isFunction(this.settings.calculate) &&
          (this.nice = this.settings.calculate),
        this.settings.onstatechange &&
          e.isFunction(this.settings.onstatechange) &&
        ...
        (this.domNode = e(
          ...
          e.extend(this.o, {
            ...
            labels: {
              0: {
                o: this.domNode
                  .find(n.selector + "value")
                  .not(n.selector + "value-to"),
              },
              1: {
                o: this.domNode
                  .find(n.selector + "value")
                  .filter(n.selector + "value-to"),
              },
            },
            limits: {
              0: this.domNode
                .find(n.selector + "label")
                .not(n.selector + "label-to"),
              1: this.domNode
                .find(n.selector + "label")
                .filter(n.selector + "label-to"),
            },
          }),
          ...
          t.settings.value.split(";")[1] ||
            ((this.settings.single = !0),
        ...
        this.setValue(),
          this.o.pointers[0] &&
            ...
            this.o.value.css({
              ...
              width:
                this.o.pointers[1].value.prc -
                this.o.pointers[0].value.prc +
                "%",
            }),
      ...
      (r.prototype.redrawLabels = function (e) {
        function t(e, t, r) {
          return (
            ...
            t.border + t.label / 2 > n.sizes.domWidth
              ? ((t.margin = 0), (t.right = !0))
              : (t.right = !1),
            e.o.css({
              left: r + "%",
              marginLeft: t.margin,
        ...
        if (!this.settings.single) {
          ...
          switch (e.uid) {
            case 0:
              s.border + s.label / 2 >
              u.o.offset().left - this.sizes.domOffset.left
                ? (u.o.css({
                    visibility: "hidden",
                  }),
                  ...
                  (i = (o.value.prc - i) / 2 + i),
                  o.value.prc != e.value.prc &&
                    (r.value.html(
                      this.nice(e.value.origin) +
                        " – " +
                        this.nice(o.value.origin)
                    ),
                    (s.label = r.o.outerWidth()),
                    (s.border = (i * this.sizes.domWidth) / 100)))
                : u.o.css({
                    visibility: "visible",
                  });
              break;
            case 1:
              s.border - s.label / 2 <
              u.o.offset().left - this.sizes.domOffset.left + u.o.outerWidth()
                ? (u.o.css({
                    visibility: "hidden",
                  }),
                  u.value.html(this.nice(o.value.origin)),
        ...
        if (this.settings.limits) {
          ...
          for (key in this.o.pointers)
            if (!this.settings.single || key == 0) {
              ...
              r + n.o.outerWidth() > this.sizes.domWidth - i.outerWidth() &&
                (e[1] = !1);
            }
          for (var s = 0; s < e.length; s++)
            e[s]
              ? this.o.limits[s].fadeIn("fast")
              : this.o.limits[s].fadeOut("fast");
        }
      }),
      ...
      (r.prototype.getValue = function () {
        ...
        return (
          e.each(this.o.pointers, function (e) {
            this.value.prc != undefined &&
              !isNaN(this.value.prc) &&
              (n += (e > 0 ? ";" : "") + t.prcToValue(this.value.prc));
          }),
          n
        );
      }),
      ...
      (r.prototype.valueToPrc = function (e, t) {
        if (
          ...
          var u = t.limits(
            ((e - this.settings.from) * 100) / this.settings.interval
          );
        return u;
      }),
      (r.prototype.round = function (e) {
        return (
          (e = Math.round(e / this.settings.step) * this.settings.step),
          this.settings.round
            ? (e =
                Math.round(e * Math.pow(10, this.settings.round)) /
      ...
      (r.prototype.nice = function (t) {
        return (
          (t = t.toString().replace(/,/gi, ".").replace(/ /gi, "")),
          e.formatNumber
            ? e
                .formatNumber(new Number(t), this.settings.format || {})
                .replace(/-/gi, "−")
            : new Number(t)
        );
      }),
      ...
      (i.prototype.onmouseup = function (t) {
        this.parent.settings.callback &&
          e.isFunction(this.parent.settings.callback) &&
          this.parent.settings.callback.call(
            this.parent,
      ...
      (i.prototype.calc = function (e) {
        var t = this.limits(
          ((e - this._parent.offset.left) * 100) / this._parent.width
        );
        return t;
      }),
...
window.Modernizr = (function (n, t, i) {
  ...
  var r = {},
    ...
    o;
  c =
    !u(h, "undefined") && !u(h.call, "undefined")
      ? function (n, t) {
          return h.call(n, t);
        }
      : function (n, t) {
        ...
        (r = function () {
          ...
          return this instanceof r
            ? ((f = function () {}),
              ...
              Object(u) === u ? u : e)
            : t.apply(n, i.concat(s.call(arguments)));
        }),
        r
      );
    });
  ...
  for (o in f)
    c(f, o) &&
      ((e = o.toLowerCase()), (r[e] = f[o]()), y.push((r[e] ? "" : "no-") + e));
  return (
    (r.addTest = function (n, t) {
      if (typeof n == "object") for (var u in n) c(n, u) && r.addTest(u, n[u]);
      else {
...
Modernizr.addTest("cssfilters", function () {
  ...
  return (
    (n.style.cssText = Modernizr._prefixes.join("filter:blur(2px); ")),
    !!n.style.length &&
    ...
    u.prototype = {
      init: function () {
        !Modernizr.cssfilters &&
          ...
          ((element = n(this.element)),
          (this.cssFilterDeprecated(element) || this.settings.fade) &&
      ...
      getComputedStyle: function (n) {
        var i = {},
          ...
          u,
          o;
        for (i = t.getComputedStyle(n, null), r = 0, e = i.length; r < e; r++)
          (u = i[r]), (o = i.getPropertyValue(u)), (f[u] = o);
        return f;
      },
      ...
      getImgParams: function (n) {
        var t = {};
        return (
          (t.styles = this.getComputedStyle(n[0])),
          (t.svg = {
            url: n[0].src,
      ...
      getBgParams: function (t) {
        var i = {},
          r;
        return (
          (r = this.extractUrl(t.css("background-image"))),
          (bgSize = this.getBgSize(r, t.css("background-size"))),
          (offset = this.positionToNegativeMargin(
      ...
      switchImage: function (t) {
        ...
        r = n(
          '<div class="grayscale-replaced ' +
            ...
            '" style="' +
            i.svg.offset +
            '"><defs><filter id="gray"><feColorMatrix type="matrix" values="0.3333 0.3333 0.3333 0 0 0.3333 0.3333 0.3333 0 0 0.3333 0.3333 0.3333 0 0 0 0 0 1 0" /></filter></defs><image filter="url("#gray")" x="0" y="0" width="' +
            i.svg.width +
            '" height="' +
            i.svg.height +
        ...
        i.styles.overflow =
          ...
          i.styles["overflow-y"] =
            "hidden";
        this.settings.fade &&
          (i.styles = this.setFadeStyles(i.styles, i.svg.url));
        r.css(i.styles);
        t.replaceWith(r);
      },
    };
      ...
      return (
        this.each(function () {
          n.data(this, "plugin_" + i) ||
            n.data(this, "plugin_" + i, new u(this, t));
        }),
        this
      );
    };
      ...
      t.handler = function (t) {
        ...
        if (
          ...
          !(
            ...
            (n.hotkeys.options.filterTextInputs &&
              n.inArray(t.target.type, n.hotkeys.textAcceptingInputTypes) > -1)
          )
        ) {
          var f = t.type !== "keypress" && n.hotkeys.specialKeys[t.which],
            ...
            e = {};
          for (
            n.each(["alt", "ctrl", "shift"], function (n, i) {
              t[i + "Key"] && f !== i && (u += i + "+");
            }),
              t.metaKey && !t.ctrlKey && f !== "meta" && (u += "meta+"),
              t.metaKey &&
                f !== "meta" &&
                u.indexOf("alt+ctrl+shift+") > -1 &&
                (u = u.replace("alt+ctrl+shift+", "hyper+")),
              f
                ? (e[u + f] = !0)
                : ((e[u + s] = !0),
...
(function (n) {
  for (
    var t,
      i,
      f = document.getElementsByTagName("head")[0].style,
      u =
  ...
  t &&
    ((i = t.replace(/[tT]ransform/, "TransformOrigin")),
    i[0] == "T" && (i[0] = "t"));
  eval('IE = "v"=="\v"');
  jQuery.fn.extend({
    rotate: function (t) {
      ...
      if (this.length !== 0 && typeof t != "undefined") {
        for (
          ...
          (i = this.get(r)),
            i.Wilq32 && i.Wilq32.PhotoEffect
              ? i.Wilq32.PhotoEffect._handleRotation(t)
              : ((e = n.extend(!0, {}, t)),
    ...
    getRotateAngle: function () {
      for (var t, i = [], n = 0, r = this.length; n < r; n++)
        (t = this.get(n)),
          t.Wilq32 &&
            t.Wilq32.PhotoEffect &&
            (i[n] = t.Wilq32.PhotoEffect._angle);
      return i;
    },
    stopRotate: function () {
      for (var t, n = 0, i = this.length; n < i; n++)
        (t = this.get(n)),
          t.Wilq32 &&
            t.Wilq32.PhotoEffect &&
            clearTimeout(t.Wilq32.PhotoEffect._timer);
    },
  });
  ...
  Wilq32.PhotoEffect.prototype = {
    _setupParameters: function (n) {
      ...
      this._parameters.animateTo =
        typeof n.animateTo == "number" ? n.animateTo : this._angle;
      this._parameters.step = n.step || this._parameters.step || null;
      this._parameters.easing =
        n.easing || this._parameters.easing || this._defaultEasing;
      this._parameters.duration =
        "duration" in n
          ? n.duration
          : n.duration || this._parameters.duration || 1e3;
      this._parameters.callback =
        n.callback || this._parameters.callback || this._emptyFunction;
      this._parameters.center = n.center ||
        this._parameters.center || ["50%", "50%"];
      this._rotationCenterX =
        typeof this._parameters.center[0] == "string"
          ? (parseInt(this._parameters.center[0], 10) / 100) *
            this._imgWidth *
            this._aspectW
          : this._parameters.center[0];
      this._rotationCenterY =
        typeof this._parameters.center[1] == "string"
      ...
      try {
        ...
        return function (n) {
          return document.createElement(
            "<" + n + ' xmlns="urn:schemas-microsoft.com:vml" class="rvml">'
          );
        };
      }
    })());
...
function panelBind(n) {
  ...
  $("#tool-crop").click(function () {
    ...
    SMH.croping ||
      ...
      (i = $.pb({
        ...
        oBtnText: "确定",
        content:
          '<span>请调整方框来选择裁切的区域！</span><br/><span>长宽比：</span><select id="aspectRatio"><option value="0">不限制</option><option value="1">正方形(1:1)</option><option value="2/3">长方形(2:3)</option><option value="3/4">长方形(3:4)</option></select><br><span>验证码：</span><input type="text" name="code" size="4" maxlength="4"/><img name="code" src="" width="50px" height="21px" style="vertical-align: top;" />',
        onCancel: function () {
          t.destroy();
          SMH.croping = !1;
                  ...
                  success: function (r) {
                    r.success
                      ? (i.setContent(
                          '<span><a href="' +
                            r.img +
                            '" target="_blank">图片裁切</a>完成！建议您分享图片以便持久保存。</span><div class="bdsharebuttonbox" data-tag="share_crop"><a class="bds_mshare" data-cmd="mshare"></a><a class="bds_qzone" data-cmd="qzone" href="#"></a><a class="bds_tsina" data-cmd="tsina"></a><a class="bds_baidu" data-cmd="baidu"></a><a class="bds_renren" data-cmd="renren"></a><a class="bds_tqq" data-cmd="tqq"></a><a class="bds_more" data-cmd="more">更多</a></div>'
                        ),
      ...
      $("img[name=code]")
        .click(function () {
          $(this).attr(
            "src",
            "/tools/verify_code.ashx?NumCount=4&id" + new Date()
          );
        })
  ...
  $("#tool-gray").click(function () {
    ...
    n
      ? ($(this).addClass("sel"),
        $("img[data-tag=mangaFile]").addClass("grayscale").gray())
      : location.reload(!1);
  });
  SMH.store.get("speed")
    ? $("#tool-speed").addClass("sel")
    : $("#tool-speed").removeClass("sel");
...
var servs = [
  ...
  pfuncs = [
    ...
    },
    {
      ...
      fn: function () {
        $("#tbBox").append(
          '<div id="efpLeftArea" class="arrLeft" title="上一张" onclick="SMH.prev();"></div><div id="efpRightArea" class="arrRight" title="下一张" onclick="SMH.next();"></div>'
        );
        sys.ie6 &&
          $("#efpLeftArea,#efpRightArea")
            .css(
              "filter",
              'progid:DXImageTransform.Microsoft.AlphaImageLoader(enabled=true, sizingMethod=image, src="/images/dian.png");'
            )
            .css(
              "background",
              "url(/images/dian.png) no-repeat 0 0 !important;"
            )
            .height(600);
      },
    },
...
SMH.utils = (function () {
  ...
  return {
    ...
    getQuery: function (n) {
      var t =
        RegExp("[#&]" + n + "=([^&]*)").exec(window.location.hash) ||
        RegExp("[0-9]+_" + n + "([^&]*).html").exec(window.location);
    ...
    moreLoad: function () {
      $("#tbBox").append(
        '<div align="center" id="mangaMoreBox"></div><div class="loading-box" id="loading" style="display:none;"><img src="/images/sloading.gif" alt="" /></div>'
      );
    ...
    pageTop: function () {
      var n = document,
        t =
          /iPad|iPhone/i.test(navigator.userAgent.toLowerCase()) == !0
            ? window.pageYOffset
            : Math.max(n.documentElement.scrollTop, n.body.scrollTop);
    ...
    imgRender: function (n, t) {
      ...
      u
        ? (i > $(window).width() - 20
            ? $(n).width($(window).width() - 20)
            : i < $("#mangaBox").width() && $(n).width($("#mangaBox").width()),
          $("#tool-zoom").removeClass().addClass("sel fit").text("适应"))
        : r != 0 &&
          ($(n).width(i + (i * r) / 100),
          $("#tool-zoom")
            .text(
              (r > 0 ? "+" : "-") +
                $.formatNumber(Math.abs(r), {
                  format: "00",
                })
            )
            .removeClass()
            .addClass("sel zoom" + (r > 0 ? "in" : "out")));
      pVars.curFunc == 2 &&
        sys.ie6 &&
        $("#efpLeftArea,#efpRightArea").height($("#tbBox").height());
      SMH.store.get("grayscale") && $(n).gray();
      typeof $('[data-tag="mangaFile"]').rotate != "undefined" &&
        ($('[data-tag="mangaFile"]').rotate(0),
        t ? SMH.rotate.init() : SMH.rotate.render());
    },
    imgGrayScale: function () {
      SMH.store.get("grayscale") &&
        ($("img[data-tag=mangaFile]:last").addClass("grayscale"),
...
(SMH.imgData = (function () {
  return function (n) {
    ...
    function s() {
      var n = "HX",
        ...
        r;
      return (
        typeof $.cookie != "undefined" && (n = $.cookie("country")),
    ...
    var t = $.extend({}, n),
      ...
      e = "isAdult";
    return (
      f.push(pVars.curHost),
      {
        init: function () {
          if (
            (this.writeList(),
            $.each(
              ["autosize|0", "grayscale|0", "simple|0", "speed|1"],
              function (n, t) {
                var i = t.split("|");
                SMH.store.get(i[0]) == null && SMH.store.set(i[0], i[1] == "1");
              }
            ),
            (SMH.store.get("zoom") == null ||
              Math.abs(SMH.store.get("zoom")) > 80) &&
          ...
          var n = document.createElement("canvas"),
            i =
              n.getContext &&
              n.getContext("2d") &&
              n.toDataURL("image/webp").indexOf("data:image/webp") == 0;
          i ||
            $.each(t.files, function (n, i) {
        ...
        preInit: function () {
          if (
            ...
            var n = this;
            $.getJSON(
              "/tools/submit_ajax.ashx?action=user_check_login",
              function (t) {
                typeof $.cookie != "undefined" &&
                  typeof t.country != "undefined" &&
                  $.cookie("country") != t.country &&
                  $.cookie("country", t.country, {
                    expires: 7,
                    path: "/",
                  });
        ...
        getHost: function () {
          ...
          try {
            ...
            i == null
              ? ((pVars.curServ = 0), SMH.store.set("imgServ", pVars.curServ))
              : ((n = parseInt(i)),
                n >= 0 && n < servs.length && (pVars.curServ = n));
            i = SMH.store.get("imgHost");
            i == null
              ? ((r = SMH.utils.getRandomIndex(servs[pVars.curServ].hosts)),
                SMH.store.set("imgHost", r),
                (pVars.curHost = r))
              : ((n = parseInt(i)),
                n >= 0 &&
                  n < servs[pVars.curServ].hosts.length &&
                  (pVars.curHost = n));
            pVars.manga.filePath = SMH.utils.getPath(
        ...
        writeList: function () {
          var i, n, f, r, u;
          for (this.getHost(), i = [], n = 0, f = servs.length; n < f; n++)
          ...
          for (
            ...
            (r = n == pVars.curFunc ? ['class="current"', ""] : ["", ""]),
              i.push(
                '<li class="pfunc"><a href="javascript:void(0)" ' +
                  r[0] +
                  ' onclick="SMH.setFunc(' +
                  n +
                  ')">' +
          ...
          for (
            ...
            i.push(
              '<option value="' +
                (u + 1) +
                '"' +
                (u + 1 == pVars.page ? ' selected="selected"' : "") +
                ">第" +
                (u + 1) +
                "页</option>"
            );
        ...
        getPage: function () {
          ...
          return (
            (n = n <= 0 ? 1 : n >= t.files.length ? t.files.length : n),
            parseInt(n, 10)
          );
        },
        // 重点?
          ...
          c(function () {
            ...
            $(
              '<img alt="' +
                ...
                '" id="mangaFile" src="' +
                pVars.curFile +
                '" class="mangaFile" data-tag="mangaFile" style="display:block;" />'
            )
              .load(function () {
                n.success(this);
              })
        ...
        error: function (n) {
          var e = this;
          r < servs[pVars.curServ].hosts.length
            ? (u && clearTimeout(u),
              r == 0
                ? (pVars.curFile += "&_" + sys.tk)
                : ((pVars.curHost = o(f)),
                  (pVars.manga.filePath = SMH.utils.getPath(
                    servs[pVars.curServ].hosts[pVars.curHost].h,
                    t.path
            ...
            : ($("#imgLoading").hide(),
              $("#mangaBox").html(
                '<span class="nopic">图片载入失败，请 " 按F5键刷新页面 " 或 "切换服务器线路" ，如果依然不行，请 " 进行报错，管理员会尽快解决 " :(</span>'
              ));
        },
        reload: function (n, t) {
          var r = this,
        ...
        moreLoad: function (n) {
          function v() {
            window.loaded != 1 &&
              (pVars.page < t.files.length ? h() : (window.loaded = 1));
          }
          function h() {
            var r;
            ...
            var u = pVars.page + 1,
              f =
                '<img src="' +
                i(pVars.page) +
                '" alt="" data-tag="mangaFile" style="display:block;" />',
              e =
                '<p class="img_info">(<span class="img_page">' +
                u +
                "</span>/" +
                t.files.length +
                ")</p>";
          ...
          function w() {
            var i = n.offset().top,
              ...
              u = r;
            return (
              $("#mangaMoreBox img").each(function (n) {
          ...
          if (pVars.page != t.files.length && s()) {
            ...
            var u = -1,
              y = setInterval(function () {
                ...
                f + r + 6e3 >= n.offset().top + n.height() &&
                  $.preLoadImg(i(u), function () {
                    h();
                  });
              }, 100),
              c = -1,
  ...
  (function (n) {
    ...
    t.fn = t.prototype = {
        ...
        var u = n.extend({}, t.defaults, i || {}),
          s = [
            ...
            u.head
              ? '<div class="pb-hd">' +
                (u.xBtn
                  ? '<a class="pb-x" href="javascript:;" title="关闭">✕</a>'
                  : "") +
                '<span class="pb-title">' +
                u.title +
                "</span></div>"
            ...
            u.foot
              ? '<div class="pb-ft">' +
                (u.cBtn
                  ? '<a class="pb-btn pb-cl">' + u.cBtnText + "</a>"
                  : "") +
                '<a class="pb-btn pb-ok">' +
                u.oBtnText +
                "</a></div>"
              : "",
            "</div></div>",
      ...
      _zindex: function () {
        return (
          (window.pb_zindex = window.pb_zindex || 2209), ++window.pb_zindex
        );
      },
      ...
      _setMask: function () {
        var t = this,
          ...
          r;
        n("#pb-mask").length
          ? (t._setMaskZindex(), t._setPbZindex())
          : ((i =
              "position:fixed;width:100%;height:100%;top:0;left:0;filter:alpha(opacity=30);opacity:0.3;overflow:hidden;background-color:#000;_position:absolute;left:expression(documentElement.scrollLeft+documentElement.clientWidth-this.offsetWidth);top:expression(documentElement.scrollTop+documentElement.clientHeight-this.offsetHeight);"),
            (r = e
              ? '<iframe src="about:blank" style="width:100%;height:100%;position:absolute;top:0;left:0;z-index:-1;filter:alpha(opacity=0)"></iframe>'
              : ""),
            n('<div id="pb-mask" style="' + i + '">' + r + "</div>")
              .css("z-index", t._zindex())
      ...
      resize: function (n, t) {
        var i = this;
        return (
          i.$pb.css("width", u.call(Math, 150, n) + "px"),
      ...
      setPos: function (n, t) {
        ...
        return (
          n === "c" &&
            ((n = r.height() - u.$pb.outerHeight()),
            (n = n > 0 ? e + (n >> 1) - (n >> 3) : 0)),
          t === "c" &&
            ((t = r.width() - u.$pb.outerWidth()),
            (t = t > 0 ? f + (t >> 1) : 0)),
          u.$pb.css({
            top: n,
            left: t,
      ...
      dispose: function () {
        ...
        t.focus
          ? (t.focus.opts.mask ? r._setMaskZindex() : n("#pb-mask").hide(),
            n(".pb").last().css("z-index", r._zindex()))
          : n("#pb-mask").remove();
  ...
  (function (n) {
    n.fn.center = function (t) {
      ...
      return this.each(function () {
        ...
        delete i.relative;
        i.position == "fixed" &&
          n.browser.version == "6.0" &&
          ((i.marginTop += n(window).scrollTop()),
          (i.position = "absolute"),
...
SMH.pager = function (n) {
  ...
  var i = [],
    u = function (t) {
      ...
      t === n.cp
        ? i.push('<span class="current">' + (t + 1) + "</span>")
        : i.push(
            '<a href="javascript:SMH.utils.goPage(' +
              (t + 1) +
              ')">' +
              (t + 1) +
              "</a>"
  ...
  if (
    (i.push(
      '<a class="btn-red prev" onclick="SMH.prevC()" href="javascript:void(0);">上一章</a>'
    ),
    n.cp === 0
      ? i.push('<span class="disabled">上一页</span>')
      : i.push(
          '<a class="btn-red prev" href="javascript:SMH.utils.goPage(' +
            (pVars.page - 1) +
            ')">上一页</a>'
        ),
    r[0] > 0)
  ...
  if (r[1] < n.pc)
    for (
      n.pc - n.nee > r[1] && i.push("<span>...</span>"),
  ...
  return (
    n.cp === n.pc - 1
      ? i.push('<span class="disabled">下一页</span>')
      : i.push(
          '<a class="btn-red next" href="javascript:SMH.utils.goPage(' +
            (pVars.page + 1) +
            ')">下一页</a>'
        ),
    i.push(
      '<a class="btn-red next" onclick="SMH.nextC()" href="javascript:void(0);">下一章</a>'
    ),
    i.join("")
  );
};
SMH.backtotop = function () {
  ...
  var u =
      '<div class="backToTop"><a href="javascript:;" id="report" title="举报报错">举报报错</a><a href="javascript:;" id="backTop" title="返回顶部">回到顶部</a></div>',
    t,
    n;
  i();
...
(SMH.feedback = {}),
  (function (n, t) {
    function i() {
      ...
      return (
        n.push(
          '<div class="feedback"><form id="feedback"><h4 style="padding-top:10px;">请选择问题的类型：</h4><ul id="fdType">'
        ),
        t.each(u, function () {
          n.push(
        ...
        n.push("</ul>"),
        n.push(
          "<h4>请输入问题的描述：<span>(请输入问题的详细描述，以方便我们解决问题。您最多可输入500字。)</span></h4>"
        ),
        n.push(
          '<textarea id="fdCont" maxlength="500" resizable="false"></textarea>'
        ),
        n.push(
          "<h4>留下您的联系方式：<span>(留下您的电子邮箱，方便客服与您解决问题。更有机会获取礼品。)</span></h4>"
        ),
    ...
    function r() {
      ...
      i.length == 0)
        ? (alert("请选择问题的类型"), !1)
        : t.trim(t("#fdCont").val()) == ""
        ? (alert("请输入有关问题的描述"), t("#fdCont").focus(), !1)
        : t.trim(t("#fdContact").val()) == ""
        ? (alert("请留下您的联系方式"), t("#fdContact").focus(), !1)
        : ((n = {}),
          (n.errors = i.join(",")),
          (n.bookid = cInfo.bid),
...
SMH.chapter = (function () {
  ...
  function r(r) {
    ...
    setTimeout(function () {
      ...
      r === 1
        ? cInfo.nextId == 0
          ? (i.hide(), i.alert(cInfo.finished == 0 ? n.tip_last : n.tip_end))
          : (location.href =
              "/comic/" + cInfo.bid + "/" + cInfo.nextId + ".html")
        : cInfo.prevId == 0
        ? i.hide(n.tip_first, 2e3)
        : (location.href =
            "/comic/" + cInfo.bid + "/" + cInfo.prevId + ".html");
    }, 2e3);
  }
  var n = {
    ...
    i = (function () {
      ...
      return {
        append: function () {
          n = !0;
          var t =
            '<div id="smh-msg-box" class="smh-msg-box"><div id="smh-msg-cont" class="smh-msg-cont"></div></div>';
          sys.ie6 &&
            (t =
              '<div id="smh-msg-box" class="smh-msg-box"><iframe frameborder="0" class="smh-msg-iframe"></iframe><div id="smh-msg-cont" class="smh-msg-cont"></div></div>');
          $("body").append(t);
        },
        show: function (t) {
  ...
  return {
    ...
    confirm: function (t) {
      ...
      $.pb({
        ...
        content:
          '<div class="tip-alert"><i></i>' +
          (t === 1 ? n.tip_ready_next : n.tip_ready_prev) +
          '<br /><a href="/comic/' +
          cInfo.bid +
          '/">返回目录</a></div>',
        foot: !0,
        oBtnText:
          "是的。我知道了，直接进入" + (t === 1 ? "下" : "上") + "一章节。",
        cBtn: !1,
        onOk: function () {
          r(t);
        },
...
SMH.shortcuts = (function () {
  function u() {
    if (n == 0) {
      var t = [];
      return (
        t.push('<div class="tip-shortcuts" id="tip-shortcuts">'),
        t.push(
          '<div id="tip-close"><a title="关闭" href="javascript:void(0);">关闭</a></div>'
        ),
        t.push("<i><i></i></i>"),
...
SMH.qrcodes = (function () {
  function t() {
    if (n == 0) {
      var i =
          location.href
            .replace(/(www|tw)\.ikanman\.com/, "m.ikanman.com")
            .replace(/\_p([0-9]+)\.html/g, ".html") +
          "#p=" +
          pVars.page,
        t = [];
      return (
        t.push('<div class="tip-shortcuts" id="tip-qr">'),
        t.push("<i><i></i></i>"),
        t.push('<div class="shadow tip-cont"><ol>'),
        t.push(
          '<li><div style="float:left;"><strong>电脑版</strong><br><img src="https://api.qrserver.com/v1/create-qr-code/?size=100x100&qzone=6&data=' +
            encodeURIComponent(location.href) +
            '" /></div>'
        ),
        t.push(
          '<strong>手机版</strong><br><img src="https://api.qrserver.com/v1/create-qr-code/?size=100x100&qzone=6&data=' +
...
SMH.zoomtool = (function () {
  function i() {
    if (n == 0) {
      var t = [];
      return (
        t.push('<div class="tip-shortcuts" id="tip-zoom">'),
        t.push(
          '<div id="tip-close1"><a title="关闭" href="javascript:void(0);">关闭</a></div>'
        ),
        t.push("<i><i></i></i>"),
        t.push('<div class="shadow tip-cont"><ol>'),
        t.push(
          '<li><label><input type="checkbox" ' +
            (SMH.store.get("autosize") ? "checked" : "") +
            "/> 自适应宽度</label></li>"
        ),
        t.push(
          '<li>缩放图片</li><li><div class="slider-cont"><input id="slider-zoom" type="slider" value="' +
            SMH.store.get("zoom") +
            '" /></div></li>'
        ),
        t.push("</ol>"),
...
SMH.suggest = function (n) {
  function l() {
    if (i >= 0) window.location.href = $("#ret" + i).attr("rel");
      ...
      if (n == u || n == "")
        return (
          $("#" + t.key).focus(), window.alert("请输入要你要搜索的漫画"), !1
        );
...
SMH.history = (function () {
  function t(n) {
    ...
    if (s > i) {
      ...
      e - i < 6e4
        ? ((u = Math.ceil((e - i) / 1e3)), t.push(u, "秒前"))
        : ((u = Math.ceil((e - i) / h)),
          u == 1
            ? t.push(Math.floor(((e - i) % h) / 6e4), "分钟前")
            : t.push("今天 ", f(r.getHours()), ":", f(r.getMinutes())));
    return t.join("");
  }
  var n = {
    maxLen: 50,
  ...
  return {
    ...
    add: function (t) {
      ...
      t != null &&
        typeof t != "undefined" &&
        ($.each(n.cvalue, function (i) {
          if (this.bid == t.bid) return n.cvalue.splice(i, 1), n.len--, !1;
        }),
        n.cvalue.push(t),
        n.len++,
        n.len > n.maxLen &&
          (n.cvalue.splice(0, n.len - n.maxLen + 1), (n.len = n.maxLen)));
    ...
    remove: function (t, i) {
      if (
        ...
        n.len--,
        n.len <= 0
          ? SMH.store.remove(n.cname)
          : SMH.store.set(n.cname, n.cvalue),
        $(i).parent().hide(200),
        n.len <= 0)
      ) {
    ...
    format: function () {
      ...
      i = [];
      n.len > 0 &&
        $.each(n.cvalue, function (r, u) {
          var f = [];
          f.push(
            '<li><a class="hDelete fr" title="删除" rel="' +
              r +
              '"><span>删除</span></a>'
          );
          f.push(
            '<a class="book" href="/comic/' +
              u.bid +
              '/">' +
              u.bn +
              '</a> <em>/</em> <a href="/comic/' +
              u.bid +
              "/" +
              u.cid +
              '.html" class="red">' +
          ...
          f.push(
            '<div><span class="fr" style="line-height:1.6em;"><a href="/comic/' +
              u.bid +
              "/" +
              u.cid +
              ".html" +
          ...
          r == n.cvalue.length - 1
            ? f.push('<span class="hTime">正在浏览观看……</span>')
            : f.push('<span class="hTime">上次于 ' + t(u.t) + " 观看</span>");
          f.push("</div></li>");
          i.push(f.join(""));
        });
      u = this;
      ...
      r == 0
        ? $("#hList").html('<div class="hNone">暂时没有观看记录!</div>')
        : ($("#hList").html(
            '<div class="hList"><ul>' + i.reverse().join("") + "</ul></div>"
          ),
          $(".hList li").hover(
            function () {
...
SMH.rotate = (function () {
  function i() {
    t % 360 > 0
      ? ($("#tool-rotate").addClass("sel"), $("#tool-rotate").text(t % 360))
      : ($("#tool-rotate").removeClass("sel"), $("#tool-rotate").text("旋转"));
  }
  function r() {
      ...
      var n =
        ...
        i = function () {
          ...
          $(".book-scores").length > 0 &&
            $(".book-scores").offset().top <= i &&
            t == !1 &&
            ($.get(
              "/support/recent_score.html",
              {
                ts: n,
              },
              function (n) {
