(function (n, t) {
      ...
      ((r = n[f]), r.style) &&
        ...
        t
          ? (!e[f] && r.style.display === "none" && (r.style.display = ""),
            r.style.display === "" &&
              tt(r) &&
              (e[f] = i._data(r, "olddisplay", wi(r.nodeName))))
          : ((o = u(r, "display")),
  ...
  function yi(n, t, r, f) {
    for (
      var e = r === (f ? "border" : "content") ? 4 : t === "width" ? 1 : 0,
        o = 0;
      e < 4;
      e += 2
    )
      r === "margin" && (o += i.css(n, r + c[e], !0)),
        f
          ? (r === "content" && (o -= parseFloat(u(n, "padding" + c[e])) || 0),
            r !== "margin" &&
              (o -= parseFloat(u(n, "border" + c[e] + "Width")) || 0))
  ...
  function pi(n, t, r) {
    ...
    if (f <= 0 || f == null) {
      if (((f = u(n, t)), (f < 0 || f == null) && (f = n.style[t]), st.test(f)))
        return f;
  ...
  function wi(n) {
    ...
    return (
      f.remove(),
      (t === "none" || t === "") &&
        ((p = r.body.appendChild(
          p ||
            i.extend(r.createElement("iframe"), {
              frameBorder: 0,
              width: 0,
              height: 0,
            })
        ...
        (w && p.createElement) ||
          ((w = (p.contentWindow || p.contentDocument).document),
          w.write("<!doctype html><html><body>"),
          w.close()),
        (f = w.body.appendChild(w.createElement(n))),
        (t = u(f, "display")),
  ...
  function it(n, i, r, u, f, e) {
    ...
    e[f] = !0;
    for (
      var o, s = n[f], h = 0, l = s ? s.length : 0, c = n === ri;
      h < l && (c || !o);
      h++
    )
      (o = s[h](i, r, u)),
        typeof o == "string" &&
          (!c || e[o]
            ? (o = t)
            : (i.dataTypes.unshift(o), (o = it(n, i, r, u, o, e))));
  ...
  function nf(n, t, r) {
    ...
    for (o in t)
      if (((a = t[o]), ao.exec(a))) {
        if (
          (delete t[o], (y = y || a === "toggle"), a === (c ? "hide" : "show"))
        )
          continue;
        w.push(o);
      }
    ...
    et = function () {
      r.addEventListener
        ...
        : r.readyState === "complete" &&
          (r.detachEvent("onreadystatechange", et), i.ready());
    },
    er = {},
    wt,
    or,
  ...
  i.extend({
    ...
    isPlainObject: function (n) {
      ...
      try {
        if (
          n.constructor &&
          !yt.call(n, "constructor") &&
          !yt.call(n.constructor.prototype, "isPrototypeOf")
        )
          return !1;
      } catch (u) {
        return !1;
        ...
        : (typeof t == "boolean" && ((u = t), (t = 0)),
          ...
          (f = fr.exec(n))
            ...
            : ((f = i.buildFragment([n], t, u ? null : [])),
              i.merge(
                [],
                (f.cacheable ? i.clone(f.fragment) : f.fragment).childNodes
              )));
    },
  ...
  i.Callbacks = function (n) {
    ...
    var f,
      ...
      a = function (t) {
        for (
          f = n.memory && t, c = !0, e = l || 0, l = 0, s = r.length, o = !0;
          r && e < s;
          e++
        )
  ...
  i.support = (function () {
    ...
    u = {
      ...
      html5Clone:
        r.createElement("nav").cloneNode(!0).outerHTML !== "<:nav></:nav>",
    ...
    return (
      i(function () {
        ...
        o &&
          ...
          n.getComputedStyle &&
            ((u.pixelPosition =
              (n.getComputedStyle(t, null) || {}).top !== "1%"),
            (u.boxSizingReliable =
              (
  ...
  i.extend({
    ...
    hasData: function (n) {
      return (
        (n = n.nodeType ? i.cache[n[i.expando]] : n[i.expando]), !!n && !at(n)
      );
    },
  ...
  i.fn.extend({
    data: function (n, r) {
      ...
      if (n === t) {
        if (
          this.length &&
          ((f = i.data(e)), e.nodeType === 1 && !i._data(e, "parsedAttrs"))
        ) {
          for (h = e.attributes, l = h.length; c < l; c++)
            (o = h[c].name),
              o.indexOf("data-") ||
                ((o = i.camelCase(o.substring(5))), ui(e, o, f[o]));
  ...
  i.fn.extend({
    ...
    toggleClass: function (n, t) {
      ...
      return i.isFunction(n)
        ...
        : this.each(function () {
            if (r === "string")
              for (
                var f, s = 0, o = i(this), e = t, c = n.split(h);
                (f = c[s++]);
    ...
    hasClass: function (n) {
      for (var i = " " + n + " ", t = 0, r = this.length; t < r; t++)
        if (
          this[t].nodeType === 1 &&
          (" " + this[t].className + " ").replace(ar, " ").indexOf(i) >= 0
        )
          return !0;
      return !1;
    },
      ...
      return arguments.length
        ...
        ? ((r = i.valHooks[f.type] || i.valHooks[f.nodeName.toLowerCase()]),
          r && "get" in r && (u = r.get(f, "value")) !== t
            ? u
            : ((u = f.value),
              typeof u == "string" ? u.replace(bf, "") : u == null ? "" : u))
        : void 0;
    },
  });
  i.extend({
    ...
    attr: function (n, r, u, f) {
      ...
      if (n && c !== 3 && c !== 8 && c !== 2) {
        ...
        if (
          ...
          return o && "set" in o && h && (e = o.set(n, u, r)) !== t
            ? e
    ...
    (s = i.valHooks.button =
      {
        ...
        set: function (n, t, i) {
          ...
          return (
            u || ((u = r.createAttribute(i)), n.setAttributeNode(u)),
            (u.value = t + "")
          );
        },
      }),
  ...
  var kt = /^(?:textarea|input|select)$/i,
    ...
    br = function (n) {
      return i.event.special.hover
        ? n
        : n.replace(ne, "mouseenter$1 mouseleave$1");
    };
  i.event = {
      ...
      if (n.nodeType !== 3 && n.nodeType !== 8 && r && u && (a = i._data(n))) {
        for (
          ...
          (p = pr.exec(r[y]) || []),
            ...
            h.add &&
              (h.add.call(n, l), l.handler.guid || (l.handler.guid = u.guid)),
    ...
    remove: function (n, t, r, u, f) {
      ...
      if (y && (v = y.events)) {
        for (t = i.trim(br(t || "")).split(" "), l = 0; l < t.length; l++) {
          if (((p = pr.exec(t[l]) || []), (e = w = p[1]), (h = p[2]), !e)) {
          ...
          o.length === 0 &&
            b !== o.length &&
            ((!c.teardown || c.teardown.call(n, h, y.handle) === !1) &&
    ...
    trigger: function (u, f, e, o) {
      if (!e || (e.nodeType !== 3 && e.nodeType !== 8)) {
        var w,
          ...
          s = u.type || u,
          b = [];
        if (wr.test(s + i.event.triggered)) return;
        if (
          (s.indexOf("!") >= 0 && ((s = s.slice(0, -1)), (d = !0)),
          s.indexOf(".") >= 0 &&
            ((b = s.split(".")), (s = b.shift()), b.sort()),
        ...
        if (
          ...
          for (c in w)
            w[c].events &&
              w[c].events[s] &&
              i.event.trigger(u, f, w[c].handle.elem, !0);
          return;
        }
        if (
          ((u.result = t),
          ...
          return;
        if (
          ((p = [[e, a.bindType || s]]), !o && !a.noBubble && !i.isWindow(e))
        ) {
          for (
            k = a.delegateType || s,
            ...
            p.push([h, k]), (l = h);
          l === (e.ownerDocument || r) &&
            p.push([l.defaultView || l.parentWindow || n, k]);
        }
          ...
          for (
            ...
            (u = h.matches[c]),
              (d ||
                ...
                l !== t &&
                  ((r.result = l),
                  l === !1 && (r.preventDefault(), r.stopPropagation())));
  ...
  i.support.changeBubbles ||
    (i.event.special.change = {
      ...
      teardown: function () {
        return i.event.remove(this, "._change"), !kt.test(this.nodeName);
      },
    });
    ...
    (function (n, t) {
      ...
      function g(n, t) {
        ...
        for (i = n, c = [], l = u.preFilter; i; ) {
          (!o || (f = pi.exec(i))) &&
            (f && (i = i.slice(f[0].length) || i), c.push((h = [])));
          o = !1;
          (f = wi.exec(i)) &&
            (h.push((o = new ri(f.shift()))),
            (i = i.slice(o.length)),
        ...
        if (!r && h.length === 1) {
          ...
          for (o = et.POS.test(n) ? -1 : e.length - 1; o >= 0; o--) {
            ...
            if (
              (l = u.find[c]) &&
              (r = l(
                s.matches[0].replace(y, ""),
                (dt.test(e[0].type) && t.parentNode) || t,
                f
              ))
            ) {
      ...
      var at,
        ...
        bt = function () {
          ...
          return s(function (i, r) {
            return (
              t.push(i) > u.cacheLength && delete n[t.shift()], (n[i + " "] = r)
            );
          }, n);
        },
        ui = bt(),
        ...
        rr = l(function (n) {
          ...
          var t =
            h.getElementsByName &&
            h.getElementsByName(e).length ===
              2 + h.getElementsByName(e + 0).length;
      ...
      ti = r.contains = o.contains
        ? function (n, t) {
            ...
            return (
              n === i ||
              !!(i && i.nodeType === 1 && r.contains && r.contains(i))
            );
          }
          ...
          ID: vt
            ...
            : function (n, i, r) {
                if (typeof i.getElementById !== c && !r) {
                  ...
                  return u
                    ? u.id === n ||
                      (typeof u.getAttributeNode !== c &&
                        u.getAttributeNode("id").value === n)
                      ? [u]
                      : t
                    : [];
                }
      ...
      h.querySelectorAll &&
        (function () {
          ...
          l(function (t) {
            ...
            t.querySelectorAll("[test^='']").length &&
              n.push("[*^$]=" + f + "*(?:\"\"|'')");
    ...
    closest: function (n, t) {
      for (
        var r,
          ...
          o = this.length,
          u = [],
          e = kr.test(n) || typeof n != "string" ? i(n, t || this.context) : 0;
        f < o;
        f++
      )
        for (
      ...
      return (
        (u = u.length > 1 ? i.unique(u) : u), this.pushStack(u, "closest", n)
      );
    },
    index: function (n) {
      return n
  ...
  var dr =
    ...
    ru = oi(r),
    ni = ru.appendChild(r.createElement("div"));
  e.optgroup = e.option;
    ...
    remove: function (n, t) {
      for (var r, u = 0; (r = this[u]) != null; u++)
        (!n || i.filter(n, [r]).length) &&
          (t ||
            r.nodeType !== 1 ||
            (i.cleanData(r.getElementsByTagName("*")), i.cleanData([r])),
      ...
      return i.access(
        ...
        function (n) {
          ...
          if (
            typeof n == "string" &&
            !ce.test(n) &&
            (i.support.htmlSerialize || !gt.test(n)) &&
            (i.support.leadingWhitespace || !dt.test(n)) &&
            !e[(nu.exec(n) || ["", ""])[1].toLowerCase()]
          ) {
            n = n.replace(gr, "<$1></$2>");
            try {
              for (; u < f; u++)
    ...
    domManip: function (n, r, u) {
      ...
      if (this[0]) {
        if (
          ...
          for (
            r = r && i.nodeName(o, "tr"), a = h.cacheable || l - 1;
            e < l;
            e++
          )
            u.call(
              r && i.nodeName(this[e], "table")
                ? pu(this[e], "tbody")
                : this[e],
              e === a ? f : i.clone(f, !0, !0)
            );
  ...
  i.buildFragment = function (n, u, f) {
    ...
    return (
      ...
      n.length === 1 &&
        ...
        e.charAt(0) === "<" &&
        !le.test(e) &&
        (i.support.checkClone || !iu.test(e)) &&
        (i.support.html5Clone || !gt.test(e)) &&
  ...
  i.each(
    ...
    function (n, t) {
      i.fn[n] = function (r) {
        ...
        if (
          (e == null ||
            (e && e.nodeType === 11 && e.childNodes.length === 1)) &&
          h === 1
        )
  ...
  i.extend({
    clone: function (n, t, r) {
      ...
      if (
        ...
        !gt.test("<" + n.nodeName + ">")
          ? (e = n.cloneNode(!0))
          : ((ni.innerHTML = n.outerHTML), ni.removeChild((e = ni.firstChild))),
    ...
    clean: function (n, t, u, f) {
      var h,
        ...
        l = [];
      for (
        (t && typeof t.createDocumentFragment != "undefined") || (t = r), h = 0;
        (o = n[h]) != null;
        h++
      )
          ...
          if (typeof o == "string")
            if (he.test(o)) {
              ...
              !i.support.leadingWhitespace &&
                dt.test(o) &&
                s.insertBefore(t.createTextNode(dt.exec(o)[0]), s.firstChild);
              o = s.childNodes;
        ...
        for (h = 0; (o = l[h]) != null; h++)
          i.nodeName(o, "input")
            ...
            : typeof o.getElementsByTagName != "undefined" &&
              i.grep(o.getElementsByTagName("input"), ci);
      if (u)
        for (
          b = function (n) {
            if (!n.type || ae.test(n.type))
              return f
                ? f.push(n.parentNode ? n.parentNode.removeChild(n) : n)
                : u.appendChild(n);
          },
            h = 0;
          (o = l[h]) != null;
    ...
    (function () {
      ...
      i.sub = function () {
        ...
        n.fn.init = function (r, u) {
          return (
            u && u instanceof i && !(u instanceof n) && (u = n(u)),
    ...
    style: function (n, r, u, f) {
      if (n && n.nodeType !== 3 && n.nodeType !== 8 && n.style) {
        var o,
          ...
          c = n.style;
        if (
          ((r = i.cssProps[h] || (i.cssProps[h] = li(c, h))),
        ...
        return vi(
          ...
          u
            ? yi(
                ...
                t,
                u,
                i.support.boxSizing && i.css(n, "boxSizing") === "border-box"
              )
            : 0
        );
      },
    ...
    (i.cssHooks.opacity = {
      ...
      set: function (n, t) {
        ...
        t >= 1 &&
          ...
          (r.filter = ti.test(f) ? f.replace(ti, e) : f + " " + e);
      },
    });
  i(function () {
      ...
      i.each(["top", "left"], function (n, t) {
        i.cssHooks[t] = {
          get: function (n, r) {
            if (r) {
              var f = u(n, t);
              return st.test(f) ? i(n).position()[t] + "px" : f;
            }
          },
        };
      });
    ...
    ((i.expr.filters.hidden = function (n) {
      return (
        ...
        (!i.support.reliableHiddenOffsets &&
          ((n.style && n.style.display) || u(n, "display")) === "none")
      );
    }),
  ...
  i.each(
    ...
    function (n, t) {
      i.cssHooks[n + t] = {
        expand: function (i) {
          for (
            var u = typeof i == "string" ? i.split(" ") : [i], f = {}, r = 0;
            r < 4;
            r++
          )
      ...
      uu.test(n) || (i.cssHooks[n + t].set = vi);
    }
  );
  var no = /%20/g,
    to = /\[\]$/,
      ...
      return this.map(function () {
        ...
        .filter(function () {
          return (
            this.name &&
            !this.disabled &&
            (this.checked || ro.test(this.nodeName) || io.test(this.type))
          );
        })
        .map(function (n, t) {
          var r = i(this).val();
  ...
  l = hu.exec(a.toLowerCase()) || [];
  i.fn.load = function (n, r, u) {
    if (typeof n != "string" && cu) return cu.apply(this, arguments);
  ...
  i.extend({
    ...
    ajaxSetup: function (n, t) {
      return (
        t ? ki(n, i.ajaxSettings) : ((t = n), (n = i.ajaxSettings)), ki(n, t), n
      );
    },
    ajaxSettings: {
      url: a,
    ...
    ajax: function (n, r) {
      function p(n, r, h, l) {
        ...
        e !== 2 &&
          ...
          (f.status = n),
          (f.statusText = (r || v) + ""),
          a ? rt.resolveWith(s, [k, v, f]) : rt.rejectWith(s, [f, v, w]),
          f.statusCode(b),
          (b = t),
          y &&
            tt.trigger("ajax" + (a ? "Success" : "Error"), [f, u, a ? k : w]),
          ut.fireWith(s, [f, v]),
          y &&
            (tt.trigger("ajaxComplete", [f, u]),
      ...
      var o,
        ...
        u = i.ajaxSetup({}, r),
        s = u.context || u,
        tt = s !== u && (s.nodeType || s instanceof i) ? i(s) : i.event,
        rt = i.Deferred(),
        ...
        f = {
          ...
          getResponseHeader: function (n) {
            ...
            if (e === 2) {
              if (!w)
                for (w = {}; (i = fo.exec(g)); ) w[i[1].toLowerCase()] = i[2];
              i = w[n.toLowerCase()];
            }
            return i === t ? null : i;
          },
      ...
      u.hasContent ||
        (u.data &&
          ((u.url += (su.test(u.url) ? "&" : "?") + u.data), delete u.data),
        (o = u.url),
        u.cache === !1 &&
          ((k = i.now()),
          (d = u.url.replace(ho, "$1_=" + k)),
          (u.url =
            d + (d === u.url ? (su.test(u.url) ? "&" : "?") + "_=" + k : ""))));
  ...
  i.ajaxPrefilter("json jsonp", function (r, u, f) {
    ...
    if (r.dataTypes[0] === "jsonp" || a || v)
      return (
        ...
        (s = n[e]),
        a
          ? (r.url = c.replace(ht, "$1" + e))
          : v
          ? (r.data = h.replace(ht, "$1" + e))
        ...
        f.always(function () {
          n[e] = s;
          r[e] && ((r.jsonpCallback = u.jsonpCallback), vu.push(e));
            ...
            u = function (n, f) {
              ...
              try {
                if (u && (f || o.readyState === 4))
                  if (
                    ((u = t),
                    h && ((o.onreadystatechange = i.noop), ot && delete y[h]),
                    f)
                  )
  ...
  i.each(["toggle", "show", "hide"], function (n, t) {
    ...
    i.fn[t] = function (u, f, e) {
      return u == null ||
        typeof u == "boolean" ||
        (!n && i.isFunction(u) && i.isFunction(f))
  ...
  i.fx.timer = function (n) {
    n() &&
      i.timers.push(n) &&
      !ct &&
      (ct = setInterval(i.fx.tick, i.fx.interval));
  };
  i.fx.interval = 13;
  i.fx.stop = function () {
    clearInterval(ct);
  ...
  i.offset = {
    ...
    setOffset: function (n, t, r) {
      ...
      var e = i(n),
        ...
        a = i.css(n, "left"),
        v =
          (f === "absolute" || f === "fixed") && i.inArray("auto", [l, a]) > -1,
        u = {},
        s = {},
        h,
        c;
    ...
    offsetParent: function () {
      return this.map(function () {
        for (
          ...
          n && !bt.test(n.nodeName) && i.css(n, "position") === "static";
      ...
      i.fn[n] = function (f) {
        return i.access(
          ...
          function (n, f, e) {
            ...
            o
              ? o.scrollTo(u ? i(o).scrollLeft() : e, u ? e : i(o).scrollTop())
              : (n[f] = e);
          },
          n,
          f,
  ...
  (function () {
    ...
    function r(f, e) {
      var h,
        ...
        s = e[f],
        p;
      if (s && ((p = $.type(s)), /date|string|number|boolean/i.test(p)))
        return o(s, p);
      ...
      switch (typeof s) {
        ...
        case "object":
          if (!s) return "null";
          if (((n += u), (l = []), $.type(s) === "Array")) {
            for (v = s.length, h = 0; h < v; h += 1) l[h] = r(h, s) || "null";
            return (
              (c =
                l.length === 0
                  ? "[]"
      ...
      t.handler = function (t) {
        ...
        if (
          ...
          var e = t.type !== "keypress" && n.hotkeys.specialKeys[t.which],
            ...
            o = {};
          for (
            t.altKey && e !== "alt" && (f += "alt+"),
              t.ctrlKey && e !== "ctrl" && (f += "ctrl+"),
              t.metaKey && !t.ctrlKey && e !== "meta" && (f += "meta+"),
              t.shiftKey && e !== "shift" && (f += "shift+"),
              e
                ? (o[f + e] = !0)
                : ((o[f + h] = !0),
                  (o[f + n.hotkeys.shiftNums[h]] = !0),
                  f === "shift+" && (o[n.hotkeys.shiftNums[h]] = !0)),
              s = 0,
              c = i.length;
            s < c;
            s++
          )
            if (o[i[s]]) return r.apply(this, arguments);
        }
      };
    }
  }
...
window["\x65\x76\x61\x6c"](
  (function (i, k, a, n, m, an) {
    m = function (a) {
      return (
        (a < k ? "" : m(window["\x70\x61\x72\x73\x65\x49\x6e\x74"](a / k))) +
        ((a = a % k) > 35
          ? window["\x53\x74\x72\x69\x6e\x67"][
              "\x66\x72\x6f\x6d\x43\x68\x61\x72\x43\x6f\x64\x65"
            ](a + 29)
          : a["\x74\x6f\x53\x74\x72\x69\x6e\x67"](36))
      );
    };
    if (
...
var pVars = pVars || {},
  ...
  sys = (function () {
    ...
    return {
      ...
      mobile:
        /(iPhone|iPad|iPod|Android|BlackBerry|NokiaN|Symbian|Windows Phone|MQQBrowser)/gi.test(
          n
        ),
    };
  })();
  ...
  (function (n, t, i) {
    ...
    if (
      ...
      (r = i[u]),
        ...
        (n.getAll = function () {
          for (var u = {}, t, i = 0; i < r.length; ++i)
            (t = r.key(i)), (u[t] = n.get(t));
          return u;
        });
      ...
      n.set = s(function (t, i, r) {
        return ((i = c(i)), r === undefined)
          ? n.remove(i)
          : (t.setAttribute(i, n.serialize(r)), t.save(u), r);
      });
      n.get = s(function (t, i) {
        return (i = c(i)), n.deserialize(t.getAttribute(i));
      });
      ...
      n.getAll = s(function (t) {
        for (
          var e = t.XMLDocument.documentElement.attributes, r = {}, i, u, f = 0;
          (i = e[f]);
          ++f
        )
          (u = c(i.name)), (r[i.name] = n.deserialize(t.getAttribute(u)));
        return r;
      });
    }
    n.cookie = {
      ...
      clear: function () {
        for (var i = h.cookie.split(";"), n, r, t = 0, u = i.length; t < u; t++)
          (n = jQuery.trim(i[t])),
      ...
      getAll: function () {
        ...
        for (
          i = document.cookie.split(";"), u = {}, t = 0, f = i.length;
          t < f;
          t++
        )
          (r = jQuery.trim(i[t]).split("=")),
...
(pVars = {
  ...
  shortcuts: {
    ...
    tip: function () {
      var n = [];
      return (
        n.push(pfuncs[pVars.curFunc].desc),
        n.push(
          '<strong>上一页：</strong><span class="keyboard key-left"></span>方向键左键<br /><strong>下一页：</strong><span class="keyboard key-right"></span>方向键右键<br /><strong>上一章：</strong><span class="keyboard key-z"></span>Z键<br /><strong>下一章：</strong><span class="keyboard key-x"></span>X键'
        ),
        n.push(
          '<strong>开关灯：</strong><span class="keyboard key-c"></span>C键'
        ),
        n.push(
          '<strong>回顶部：</strong><span class="keyboard key-v"></span>V键'
        ),
        n.push(
          '<strong>全　屏：</strong><span class="keyboard key-f11"></span>F11键'
        ),
        "<li>" + n.join("</li><li>") + "</li>"
      );
    },
  ...
  (function () {
    ...
    pVars.lighter.cvalue = SMH.store.get(pVars.lighter.cname);
    pVars.lighter.cvalue =
      pVars.lighter.cvalue === null || pVars.lighter.cvalue == undefined
        ? 0
        : pVars.lighter.cvalue;
    pVars.lighter.cvalue == 1 && (cssFile = n + "/css/black.css");
    sys.mobile && (cssFile = n + "/css/none.css");
    typeof cssFile != "undefined" &&
      $("<link>")
        .attr({
          rel: "stylesheet",
          type: "text/css",
